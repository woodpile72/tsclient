...
pkgdatadir = $(datadir)/tsclient
pkgincludedir = $(includedir)/tsclient
pkglibdir = $(libdir)/tsclient
pkglibexecdir = $(libexecdir)/tsclient
...
am__installdirs = "$(DESTDIR)$(man1dir)" \
	"$(DESTDIR)$(applicationsdir)" "$(DESTDIR)$(desktopdir)" \
	"$(DESTDIR)$(mimedir)"
NROFF = nroff
MANS = $(man1_MANS)
DATA = $(applications_DATA) $(desktop_DATA) $(mime_DATA)
...
GMOFILES =  ar.gmo ca.gmo cs.gmo da.gmo de.gmo el.gmo es.gmo fi.gmo fr.gmo gr.gmo he.gmo hu.gmo id.gmo it.gmo ja.gmo mk.gmo ms.gmo nl_NL.gmo nb.gmo pa.gmo pl_PL.gmo pt_BR.gmo pt_PT.gmo ru.gmo sv.gmo tr.gmo xh.gmo zh_CN.gmo zh_HK.gmo zh_TW.gmo
...
OBJEXT = o
PACKAGE = tsclient
PACKAGE_BUGREPORT = http://www.gnomepro.com/tsclient
...
PKG_CONFIG_LIBDIR = 
PKG_CONFIG_PATH = 
POFILES =  ar.po ca.po cs.po da.po de.po el.po es.po fi.po fr.po gr.po he.po hu.po id.po it.po ja.po mk.po ms.po nl_NL.po nb.po pa.po pl_PL.po pt_BR.po pt_PT.po ru.po sv.po tr.po xh.po zh_CN.po zh_HK.po zh_TW.po
POSUB = po
PO_IN_DATADIR_FALSE = 
PO_IN_DATADIR_TRUE = 
SET_MAKE = 
...
installdirs-am:
	for dir in "$(DESTDIR)$(man1dir)" "$(DESTDIR)$(applicationsdir)" "$(DESTDIR)$(desktopdir)" "$(DESTDIR)$(mimedir)"; do \
...
install-data-am: install-applicationsDATA install-data-local \
	install-desktopDATA install-man install-mimeDATA
...
uninstall-am: uninstall-applicationsDATA uninstall-desktopDATA \
	uninstall-local uninstall-man uninstall-mimeDATA
